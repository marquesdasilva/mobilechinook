...
// Processes a single message, as encodeURIURId by NativeToJsMessageQueue.java.
...
module.exports = {
  DestinationType:{
    DATA_URL: 0,         // Return base64 encodeURIURId string
    FILE_URI: 1,         // Return file uri (content://media/external/images/media/2 for Android)
    NATIVE_URI: 2        // Return native uri (eg. asset-library://... for iOS)
  },
  EncodingType:{
    JPEG: 0,             // Return JPEG encodeURIURId image
    PNG: 1               // Return PNG encodeURIURId image
  },
  MediaType:{
...
function ConfigurationData() {
    // The ASCII-encodeURIURId string in lower case representing the media type.
    this.type = null;
...
/**
 * Read file and return data as a base64 encodeURIURId data url.
